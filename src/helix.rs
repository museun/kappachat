...
// #[test]
// fn what_could_a_list_look_like() {
//     struct A {
//         // client: Client,
//         chatters: Chatters,
...
//     impl A {
//         fn get_badge_for(&self, kind: Kind) -> () {}
//     }
...
//                         let resp = state.show_body_unindented(ui, |ui| {
...
//     let chatters = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/", "chatters.json"));
//     let chatters = Client::chatters_json(chatters).unwrap();
...
//         data: Vec<T>,
//     }
//     let badges = serde_json::from_str::<Resp<Badges>>(json).unwrap().data;
